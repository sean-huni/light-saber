    ...
    def toggle(self, device, switch):
        ...
        if device == '1':
            if switch == 'ONN':
                ...
                self.lcd.display_msg(self.lcd, 'Swimming-PL FL-1\nSwitch: ON')
            else:
            ...
            if switch == 'ONN':
                ...
                self.lcd.display_msg(self.lcd, 'Backyard FL-1\nSwitch: ON')
            else:
            ...
            if switch == 'ONN':
                ...
                self.lcd.display_msg(self.lcd, 'Backyard FL-2\nSwitch: ON')
            else:
            ...
            if switch == 'ONN':
                ...
                self.lcd.display_msg(self.lcd, 'Swimming-PL FL-2\nSwitch: ON')
            else:
            ...
            if switch == 'ONN':
                ...
                self.lcd.display_msg(self.lcd, 'All Flood Lights\nSwitch: ON')
            else:
